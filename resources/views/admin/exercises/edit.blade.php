...
* Copyright (c) 2020 Sachin N; Licensed GPLv3 */
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <form method="post" action="{{route('admin.exercises.update',$exercise->id)}}" autocomplete="off"
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <label class="col-sm-3 col-form-label">{{ __('Exercise Name:') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                   name="name" id="input-name" type="text"
                                                   placeholder="{{ __('exercise Name') }}"
                                ...
                                <div class="row">
                                    <label class="col-sm-3 col-form-label">{{ __('Instructions:') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('instruction') ? ' has-danger' : '' }}">
                                            <textarea
                                                    ...
                                                    required="true" aria-required="true"
                                                    value="{{ old('instruction',$exercise->instructions) }}"
                                                    rows="3">{{$exercise->instruction}}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-3 btn btn-secondary btn-sm float-left">
                                            <input type="file" name="photo_start">
                                        </div>
                                ...
                                <div class="row">
                                    <label class="col-sm-3 col-form-label">{{ __('End:') }}</label>
                                    <div class="col-sm-6">
                                        @if ($errors->has('end'))
                                        ...
                                        <span>Select an image to upload</span>
                                        <div class="col-sm-3 btn btn-secondary btn-sm float-left">
                                            <input type="file" name="photo_end">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        @if ($errors->has('video'))
                                            <span id="start-error" class="error text-danger"
                                                  for="input-modules">{{ $errors->first('video') }}</span>
                                        @endif
