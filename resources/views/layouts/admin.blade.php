            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        {{--      <a class="navbar-brand" href="#"><img src="{{ asset('images') }}/logo.png" alt="" style="width: 150px"></a>--}}<a class="navbar-brand" href="#">Physio4u</a>
                    </div>
...
{{--                                    <a class="dropdown-item" href="#">{{ __('Settings') }}</a>--}}
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logoutform').submit();">{{ __('Log out') }}</a>
                                </div>
                            </li>
                        </ul>
                    </div>
